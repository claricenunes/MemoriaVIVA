...
const HISTORY = [
  {
    ...
    corpo: 7,
    mente: 6,
    note: "Fiz uma caminhada pela manhã. Me senti mais disposta do que nos últimos dias.",
    bookmarked: false,
  },
  {
    date: "Qua, 10 jun",
    corpo: 5,
    mente: 4,
    note: "Acordei com dor de cabeça. Fiquei em casa o dia todo e não tive ânimo pra nada.",
    bookmarked: true,
  },
  {
    date: "Ter, 9 jun",
    corpo: 8,
    mente: 8,
    note: "Dia ótimo! Almocei com minha filha e fomos ao parque.",
    bookmarked: false,
  },
  {
    date: "Seg, 8 jun",
    corpo: 6,
    mente: 7,
    note: "Dormi bem. Dia tranquilo em casa com netos.",
    bookmarked: false,
  },
];
...
export default function SaudePage() {
  ...
  return (
    <main className="mv-shell">
        ...
        {saved ? (
          ...
          <GlassCard variant="hero">
            ...
            <p style={{ margin: "4px 0 var(--mv-space-4)", fontSize: "var(--mv-text-sm)", color: "var(--mv-text-secondary)" }}>
              Como você acordou hoje, Clarice?
            </p>
            ...
            >
              ...
              <div>
                ...
                <p className="mv-doctor-toggle-sub">
                  Guardar esse registro para a consulta
                </p>
              </div>
            </button>
      ...
      {/* Remédios do dia */}
      <SectionTitle title="Remédios de hoje" action="Ver todos" />
          ...
          <div key={i} className="mv-diary-entry">
            <div className="mv-diary-entry-header">
              ...
              <div className="mv-diary-entry-scores">
                <span className="mv-diary-score-pill mv-diary-score-pill--corpo">
                  🏃 {entry.corpo}/10
                </span>
                <span className="mv-diary-score-pill mv-diary-score-pill--mente">
                  🧠 {entry.mente}/10
                </span>
              </div>
            </div>
