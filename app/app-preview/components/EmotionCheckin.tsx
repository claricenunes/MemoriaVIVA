  ...
  if (saved) {
    return (
      <GlassCard variant="hero">
        ...
        <a
          href="/app-preview/saude"
          style={{ display: "block", marginTop: "var(--mv-space-3)", fontSize: "var(--mv-text-xs)", color: "var(--mv-terracota-deep)", fontWeight: 600, textDecoration: "none" }}
        >
          Ver meu diário →
        </a>
      </GlassCard>
