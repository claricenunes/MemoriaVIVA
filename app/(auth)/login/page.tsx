      ...
      <div className="mv-fade-in" style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div className="mv-card">
          <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--mv-space-4)' }}>
            ...
            >
              {pending
                ? <><i className="ti ti-loader-2" aria-hidden="true" style={{ animation: 'spin 1s linear infinite' }} /> Entrando...</>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: 'var(--mv-text-sm)', color: 'var(--mv-text-secondary)' }}>
              Ainda não tem conta?{' '}
              <a href="/register" style={{ color: 'var(--mv-terracota-deep)', fontWeight: 700, textDecoration: 'none' }}>
                Criar conta
              </a>
            </p>
          </div>
